...
The diagram below illustrates a frequency scaler module based on the above logic.

![PWM Generator Module](assets/images/freq_scale.png)
...
reg [3:0]counter = 0;
//4bit counter implies a resolution of 2^16 which is quite a lot!
